...
# mkdir /projects/multimodal/datasets/med_llava/alignment
# cd /projects/multimodal/datasets/med_llava/alignment
...
pip install tqdm
python llava/data/download_images.py --input_path /projects/multimodal/datasets/med_llava/llava_med_image_urls.jsonl --pmc_output_path /projects/multimodal/datasets/med_llava/pmc_articles/ --images_output_path /projects/multimodal/datasets/med_llava/images